        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 min-h-[400px] flex flex-col items-center justify-center">
          {berita.length === 0 ? (
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Belum Ada Berita</h2>
              <p className="text-gray-500 max-w-md mx-auto">Saat ini belum ada artikel berita yang dipublikasikan. Silakan cek kembali beberapa waktu ke depan.</p>
            </div>
          ) : (
            <div className="grid md:grid-cols-3 gap-6 w-full">{/* Render news here later */}</div>
          )}
        </div>
      </div>
    </div>
